    ...
    public class LuaEntityInspector : UnityEditor.Editor
    {
        ...
        void OnEnable()
        {
            ...
            defaultDrawer = (string name, object value, out object nvalue) =>
            {
                ...
                {
                    nvalue = EditorGUILayout.ObjectField(name, (UnityEngine.Object)value, value.GetType(), true);
                    return nvalue != value;
                }
                else
                {
            ...
            propertyTypeDrawer[typeof(Vector3)] = (string name, object value, out object nvalue) =>
            {
                nvalue = EditorGUILayout.Vector3Field(name, (Vector3)value);
                return Vector3.Distance((Vector3)nvalue, (Vector3)value) > Mathf.Epsilon;
            };
            propertyTypeDrawer[typeof(Vector2)] = (string name, object value, out object nvalue) =>
            {
                nvalue = EditorGUILayout.Vector2Field(name, (Vector2)value);
                return Vector2.Distance((Vector2)nvalue, (Vector2)value) > Mathf.Epsilon;
            };
