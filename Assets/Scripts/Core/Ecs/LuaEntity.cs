    ...
    public class LuaEntity : MonoBehaviour
    {
        public static void RegToLua(LuaState state)
        {
            state.LuaPushFunction(L =>
            {
                ...
                componentSelectIds = new List<int>();
            ...
            state.LuaSetGlobal("ECS_INIT_EDITOR_ENTITY");
            ...
            state.LuaSetGlobal("ECS_POOL_ONENTITYCREATE");
            ...
            state.LuaSetGlobal("ECS_POOL_ONENTITYDESTROY");
        }
        ...
        const int NAME_UPDATE_INTERVAL = 30;
        ...
        void Update()
        {
            if (++updateCount > 0 && Random.Range(0, NAME_UPDATE_INTERVAL) < updateCount)
            {
                UpdateName();
                updateCount = -NAME_UPDATE_INTERVAL;
            }
