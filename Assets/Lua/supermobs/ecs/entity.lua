...
entity.__index = function(t, k)
	...
	if componenttypeid ~= nil then
		...
		if property[1] then
			...
			local ret = indexpropertycache[k][2](t)
			return ret
		end
	end
end
...
ecs.setexplicitrelay(entity.__index, 1)
ecs.setexplicitrelay(entity.__newindex, 1)
...
function entity:addcomponent(componenttypeid, component)
	...
	if self:hascomponent(componenttypeid) then
		error("EntityAlreadyHasComponentException， component = " .. ecs.component.getname(componenttypeid))
	end
